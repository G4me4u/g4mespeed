...
public interface GSIServerModuleManager extends GSIModuleManager {
	 ...
	 * 
	 * @see #isExtensionInstalled(ServerPlayer, GSExtensionUID, GSVersion)
	 */
	 ...
	 * {@link #isExtensionInstalled(ServerPlayer, GSExtensionUID)} returns
	 ...
	 * 
	 * @see #sendPacket(GSIPacket, ServerPlayer, GSVersion)
	 */
	default public void sendPacket(GSIPacket packet, ServerPlayer player) {
	 ...
	 * {@link #isExtensionInstalled(ServerPlayer, GSExtensionUID, GSVersion)}
	 ...
	 * if {@link #isExtensionInstalled(ServerPlayer, GSExtensionUID)} returns
	 * true for the given player and corresponding packet extension UID.
	 * 
	 ...
	 * if {@link #isExtensionInstalled(ServerPlayer, GSExtensionUID, GSVersion)}
	 * returns true for the given player, corresponding packet extension UID, and
	 * version.
	 * 
	 * @param packet - the packet to be sent to the players.
	 ...
	 */
	default public void sendPacketToAllExcept(GSIPacket packet, ServerPlayer player) {
	 ...
	 * @param player - the player which should not receive the packet
	 */
	public void sendPacketToAllExcept(GSIPacket packet, GSVersion minExtensionVersion, ServerPlayer player);
