...
public class GSBooleanSettingPanel extends GSSettingPanel<GSBooleanSetting> {
	...
	private static final Text ENABLED_TEXT = new TranslatableText("setting.boolean.enabled").formatted(Formatting.GREEN);
	private static final Text DISABLED_TEXT = new TranslatableText("setting.boolean.disabled").formatted(Formatting.RED);
